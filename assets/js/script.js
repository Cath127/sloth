...
const startButton = document.getElementById("start-btn");  //May not need this
const questionContainerElement = document.getElementById("game-container"); //May not need this
